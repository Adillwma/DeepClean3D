...
######################################REPLACE BELOW WITH NEW FUNCTION THAT OUTPUTS 6 LISTS, XSIGNAL, XNOISE, YSIGNAL, YNOISE, ZSIGNAL, ZNOISE ##############################
...
#%% - Spherical Signal Simulator    
    ...
    for i in range (0,signal_points):    

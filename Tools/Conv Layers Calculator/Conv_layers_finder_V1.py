...
CLT2 = conv_calculator(conv_type=1, K=Kernal, P=0, S=2, D=1, H_in=CLT1[0], W_in=CLT1[1], O=1)
CLT3 = conv_calculator(conv_type=1, K=Kernal, P=0, S=2, D=1, H_in=CLT2[0], W_in=CLT2[1], O=1)
#CLT4 = conv_calculator(conv_type=1, K=Kernal, P=0, S=2, D=1, H_in=CLT3[0], W_in=CLT3[1], O=0)
#CLT5 = conv_calculator(conv_type=1, K=Kernal, P=0, S=2, D=1, H_in=CLT4[0], W_in=CLT4[1], O=(1,1))

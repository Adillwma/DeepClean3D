# -*- coding: utf-8 -*-
"""
DC3D Autoencoder V2  NOTE: added one extra lin layers over V1
...
class Encoder(nn.Module):
    ...
    def __init__(self, encoded_space_dim,fc2_input_dim, encoder_debug, record_activity):
        ...
        self.encoder_lin = nn.Sequential(
            ...
            nn.Linear(1024, 128),                   #!!! linear network layer. arguuments are input dimensions/size, output dimensions/size. Takes in data of dimensions 3* 3 *32 and outputs it in 1 dimension of size 128
            nn.ReLU(True), 

...
This AE uses leaky ReLU instead of RelU - ensures that the model can learn even when the output of a neuron is negative. 
This helps prevent dead neurons and improves the model's ability to capture complex patterns in the input data.
"""

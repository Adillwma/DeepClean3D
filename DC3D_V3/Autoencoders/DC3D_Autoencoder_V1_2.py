...
class Encoder(nn.Module):
    ...
    def __init__(self, encoded_space_dim,fc2_input_dim, encoder_debug, record_activity, dropout_prob=0.2):
        super().__init__()
...
class Decoder(nn.Module):
    ...
    def __init__(self, encoded_space_dim,fc2_input_dim, decoder_debug, record_activity, dropout_prob=0.2):
        super().__init__()
